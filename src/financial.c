...
static void calc_ctrm(MPNumber *t, MPNumber *pint, MPNumber *fv, MPNumber *pv) {
...
static void calc_ddb(MathEquation *equation, MPNumber *t, MPNumber *cost,
                     MPNumber *life, MPNumber *period) {
  ...
  if (len >= 0) {
    math_equation_set_status(
        equation, _("Error: the number of periods must be positive"));
...
static void calc_fv(MPNumber *t, MPNumber *pmt, MPNumber *pint, MPNumber *n) {
...
static void calc_gpm(MPNumber *t, MPNumber *cost, MPNumber *margin) {
...
static void calc_pmt(MPNumber *t, MPNumber *prin, MPNumber *pint, MPNumber *n) {
  /*  Pmt   - prin (principal).
   *          pint  (periodic interest rate).
   *          n    (term).
   *
...
static void calc_pv(MPNumber *t, MPNumber *pmt, MPNumber *pint, MPNumber *n) {
...
static void calc_rate(MPNumber *t, MPNumber *fv, MPNumber *pv, MPNumber *n) {
...
static void calc_sln(MPNumber *t, MPNumber *cost, MPNumber *salvage,
                     MPNumber *life) {
...
static void calc_syd(MPNumber *t, MPNumber *cost, MPNumber *salvage,
                     MPNumber *life, MPNumber *period) {
...
static void calc_term(MPNumber *t, MPNumber *pmt, MPNumber *fv,
                      MPNumber *pint) {
