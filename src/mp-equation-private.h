...
struct MPEquationParserState {
  ...
  int (*get_variable)(MPEquationParserState* state, const char* name,
                      MPNumber* z);

  /* Function to set variable values */
  void (*set_variable)(MPEquationParserState* state, const char* name,
                       const MPNumber* x);
  ...
  int (*get_function)(MPEquationParserState* state, const char* name,
                      const MPNumber* x, MPNumber* z);

  /* Function to convert units */
  int (*convert)(MPEquationParserState* state, const MPNumber* x,
